<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="login-container">
            <h1>Etudiant</h1>
            <form action="./Pages/Connexion_etudiant.php" method="post" id="loginForm">
        ...
        <div class="login-container">
            <h1>Professeur</h1>
            <form action="./Pages/Connexion_prof.php" method="post" id="loginForm1">
        ...
        <div class="login-container">
            ...
            <form action="./Pages/Connexion_admin.php" method="post" id="loginForm2">
